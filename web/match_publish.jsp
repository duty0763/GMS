      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form data-parsley-validate="" class="form-horizontal form-label-left" action="setMatch.action" method="post">
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="groundName">场地名
                  </label>


                  <div class="col-md-6 col-sm-6 ">
                    <select id="groundName" name="groundName" required="required" class="form-control">
                      <%

                        String sql = "select * from ground where groundStatus =0";
                        ResultSet rs = dao.executeQuery(sql);
                        while (rs.next()) {
                      %>
                      <option value ="default"></option>
                      <option value ="<%=rs.getString("groundName") %>"><%=rs.getString("groundName") %></option>
                      <%
                        }
                      %>
                    </select>
                ...
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="applicant">申请人
                  </label>
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="applicant" name="applicant" required="required" class="form-control">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="phone">电话
                  </label>
                  <div class="col-md-6 col-sm-6 ">
                ...
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="referee">裁判
                  </label>
                  <div class="col-md-6 col-sm-6 ">
