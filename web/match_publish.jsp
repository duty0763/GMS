              ...
              <div class="x_content">
                <form data-parsley-validate="" class="form-horizontal form-label-left">
                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">场地名
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="groundName" name="groundName" required="required" class="form-control">
                    </div>
                  </div>
                  <div class="item form-group">
                  ...
                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">电话
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                  ...
                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">裁判
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                  ...
                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">时间
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="time" name="time" required="required" class="form-control">
                    </div>
                  </div>
