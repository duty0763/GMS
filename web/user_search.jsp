                                        ...
                                        <table id="datatable" class="table table-striped table-bordered"
                                            ...
                                            <tr>
                                                ...
                                                <%if (role.equals("3")) {%>
                                                    ...
                                                    <%if (rs.getString("role").equals("2")) {%>
                                                    <td><form action="deleteManager.action" method="post"><input type="hidden" name="userId" value="<%=rs.getString("userId")%>"  /><button type="submit" class="buttons btn btn-danger">删除管理员</button></form></td>
                                                    <%}%>
