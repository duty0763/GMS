      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form data-parsley-validate="" class="form-horizontal form-label-left" action="setPublish.action" method="post">
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="refereetitle">标题
                  </label>
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="refereetitle" name="refereetitle" required="required" class="form-control">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="refereecontent">内容
                  </label>
                  <div class="col-md-6 col-sm-6 ">
                    <textarea class="form-control" rows="13" name="refereecontent" id="refereecontent"></textarea>
                  </div>
                </div>
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="refereepublisher">发布人
                  </label>
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="refereepublisher" name="refereepublisher" required="required" class="form-control">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="refereepublisherphone">电话号码
                  </label>
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="refereepublisherphone" name="refereepublisherphone" required="required" class="form-control">
                  </div>
                </div>
